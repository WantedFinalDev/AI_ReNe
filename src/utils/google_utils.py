...
def append_datas_to_spreadsheet(
    creds: Credentials, spreadsheet_id: str, sheet_name: str, datas: list
) -> GResult:
    """
    datas format should be a List of Lists: [['row1_col1', 'row1_col2'], ['row2_col1', ...]]
    """
    print(f"추가할 데이터 행 개수: {len(datas)}")
    try:
